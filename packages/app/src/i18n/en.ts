export const dict = {
  ...
  "palette.search.title": "Search",
  "palette.search.placeholder": "Search sessions",
  ...
  "prompt.readonly.message": "Read-only mode: Cannot send messages to other's projects",
