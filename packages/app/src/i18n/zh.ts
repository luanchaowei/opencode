...
export const dict = {
  ...
  "palette.search.title": "搜索",
  "palette.search.placeholder": "搜索会话",
  "palette.empty": "未找到结果",
  ...
  "prompt.readonly.message": "只读模式：无法向他人项目发送消息",
...
"dialog.fork.empty": "没有可用于分叉的消息",
  ...
  "toast.file.uploadSuccess.title": "文件上传成功",
  "toast.file.uploadSuccess.description": "{{filename}} 已保存",
  "toast.file.deleteSuccess.title": "删除成功",
  "toast.file.deleteSuccess.description": "{{filename}} 已删除",
  "toast.file.deleteFailed.title": "删除失败",
  "toast.file.deleteFailed.description": "{{filename}}: {{error}}",
  "toast.file.downloadSuccess.title": "下载成功",
  "toast.file.downloadSuccess.description": "{{filename}} 已下载",
  "toast.file.downloadFailed.title": "下载失败",
  ...
  "session.files.uploading": "上传中，请稍等...",
